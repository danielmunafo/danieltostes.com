...
- You confirm you have the **right** to submit the text you provide and that doing so does not violate agreements (for example confidentiality) that apply to you.
- You are responsible for **compliance** with laws and internal policies that apply to you (employment law, equal opportunities, privacy, etc.).
- You **verify** outputs before relying on them in real decisions.

## 5. Outputs and limitations

Outputs are **AI-generated** and may be incomplete, outdated, or wrong. They are **not** warranties of skill, availability, or performance. Public portfolio content may omit or simplify information (for example under NDAs). **Always corroborate** material facts with the candidate and authoritative sources.
...
The Assistant is provided **“as is”**. To the maximum extent permitted by law, the site owner is not liable for any loss arising from use of, or inability to use, the Assistant or from reliance on its outputs.

## 8. Changes

These terms may be updated from time to time; the effective date at the top will change. Continued use after updates constitutes acceptance of the revised terms where permitted by law.

## 9. Contact

For questions about this feature, use the contact options listed on this site (for example LinkedIn or email shown in the portfolio).
