...
- Confermi di avere il **diritto** di inviare il testo fornito e che farlo non viola accordi (ad esempio riservatezza) che ti riguardano.
- Sei responsabile della **conformità** a leggi e policy interne applicabili (lavoro, pari opportunità, privacy, ecc.).
- **Verifichi** gli output prima di basarci decisioni reali.

## 5. Output e limitazioni

Gli output sono **generati da IA** e possono essere incompleti, obsoleti o errati. **Non** sono garanzie di competenza, disponibilità o risultati. Il contenuto portfolio pubblico può omettere o semplificare informazioni (ad esempio per NDA). **Corrobora sempre** i fatti materiali con il candidato e fonti autorevoli.
...
L’Assistente è fornito **“così com’è”**. Nella misura massima consentita dalla legge, il titolare del sito non è responsabile per perdite derivanti dall’uso o dall’impossibilità di usare l’Assistente o dall’affidamento sui suoi output.
...
Per domande su questa funzione usa le opzioni di contatto indicate sul sito (ad esempio LinkedIn o email nel portfolio).
