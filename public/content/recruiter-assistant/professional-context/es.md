# Contexto profesional — temas de evidencia del portafolio

Evidencia temática usada por el Asistente de Reclutamiento con IA para recuperación y referencias. Cada sección siguiente es un cluster de afirmaciones independiente, no una línea temporal de empleos.

## Sistemas Distribuidos — Coordinación Orientada a Eventos y Aislamiento de Fallos

**Problema:** Los sistemas en producción en incorporación bancaria, automatización de garantías, sincronización facturación/factura, reporting fiscal y personalización de email transaccional requerían coordinar trabajo entre dominios independientes sin crear acoplamiento frágil, tormentas de reintento o puntos únicos de fallo.
...
**Contribuciones:** Estandaricé prácticas mediante scaffolds reutilizables, monorepos, bibliotecas UI compartidas, plantillas de prueba, CI/CD, observabilidad, documentación, registros de decisión y orientación de arquitectura para servicios de plataforma core. Mentoricé ingenieros en prácticas de entrega AI-native, impulsé estrategia de plataforma a largo plazo y habilitación de equipos. Colaboré con producto/UX/SRE/soporte/cumplimiento; produje specs, write-ups estilo RFC e informes a stakeholders en inglés escrito y oral excelente para colaboración remota cross-team.
...
## Colaboración Cross-Funcional — Entrega Matricial y Remote-First
