# Contesto professionale — temi di evidenza del portfolio

Evidenze tematiche usate dall'Assistente Recruiter IA per retrieval e riferimenti. Ogni sezione seguente è un cluster di affermazioni autonomo, non una timeline di ruoli.
...
**Contributi:** Ho standardizzato pratiche tramite scaffold riutilizzabili, monorepo, librerie UI condivise, template di test, pratiche CI/CD, miglioramenti osservabilità, documentazione, log decisionali e guida architetturale. Ho fatto mentoring su pratiche di delivery AI-native, guidato strategia di piattaforma a lungo termine e abilitazione dei team. Ho collaborato con prodotto/UX/SRE/supporto/compliance; prodotto specs, write-up stile RFC e stakeholder reporting in inglese scritto e orale eccellente per collaborazione remota cross-team.
...
## Collaborazione Cross-Funzionale — Delivery Matriciale e Remote-First
