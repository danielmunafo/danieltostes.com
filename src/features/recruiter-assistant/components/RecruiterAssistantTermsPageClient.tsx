...
type TermsMarkdownBodyProps = {
  readonly contentLocale: Locale;
};

function RecruiterAssistantTermsMarkdownBody({
  contentLocale,
}: TermsMarkdownBodyProps) {
  ...
  const isLoadingTerms = !loadError && markdown === null;
...
export function RecruiterAssistantTermsPageClient({
  ...
  return (
    <Container maxWidth="md" sx={{ py: { xs: 3, sm: 4 } }}>
      ...
      <RecruiterAssistantTermsMarkdownBody
        key={contentLocale}
